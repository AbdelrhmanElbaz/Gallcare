          ...
          messages: [
            {
              ...
              content: [
                ...
                {
                  type: "text",
                  text: `You are an expert hepatologist AI assistant. Analyze this medical image for liver/gallbladder disease indicators.

Respond ONLY with a valid JSON object in exactly this format (no markdown, no extra text):
{
  "verdict": "Healthy" | "Diseased" | "Inconclusive",
  "confidence": <number 0-100>,
  "primary_finding": "<one-sentence summary>",
  "indicators": [
    { "label": "<indicator name>", "value": "<observed value>", "status": "normal" | "abnormal" | "borderline" }
  ],
  "recommendation": "<clinical recommendation in 1-2 sentences>",
  "image_quality": "good" | "fair" | "poor",
  "note": "<any important disclaimer or caveat>"
}

If the image is NOT a medical scan (e.g. a regular photo), set verdict to "Inconclusive" and explain in primary_finding.`,
                },
              ],
            },
          ],
